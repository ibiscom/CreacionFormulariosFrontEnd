...
export class SaveButtonComponent {
  ...
  public click() {
    ...
    if (this.verFormularioCmp?.modo === 'diligenciar') {
      ...
      console.debug(
        'Se ejecutará la acción de guardado definida en la expresión lógica del botón de guardar.',
      );
      this.plantillaFormCapturaService
        .guardarFormulario(this.verFormularioCmp.formulario!)
        .subscribe({
          next: (response) => {
